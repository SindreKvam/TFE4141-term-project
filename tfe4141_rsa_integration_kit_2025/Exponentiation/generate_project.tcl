...
set source_files [list \
	...
	{*}[glob -nocomplain -directory [file normalize "$origin_dir/source/processing_elements/"] -type f *] \
...
set sim_files [list \
	...
	{*}[glob -nocomplain -directory [file normalize "$origin_dir/testbench/processing_elements/"] -type f *]\
]
